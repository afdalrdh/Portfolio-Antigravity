...
export const siteSettings = pgTable('site_settings', {
    ...
    companyName: text('company_name').default('PT ARSI KARYA UNGGUL'),
    ...
    email: text('email').default('arsikaryaunggul@gmail.com'),
    ...
    seoTitle: text('seo_title').default('PT ARSI KARYA UNGGUL — Kontraktor & Design Build'),
